...
*/ -}}
{{- define "eric-odp-base-images.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-odp-base-images.mergeAnnotations" -}}
  {{- include "eric-odp-base-images.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-odp-base-images.mergeLabels" -}}
  {{- include "eric-odp-base-images.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
